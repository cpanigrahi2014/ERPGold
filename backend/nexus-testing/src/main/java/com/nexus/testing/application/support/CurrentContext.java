package com.nexus.testing.application.support;
...
public class CurrentContext {
    @Value("${nexus.testing.default-tenant-id}") private UUID defaultTenantId;
    @Value("${nexus.testing.system-user-id}") private UUID systemUserId;
