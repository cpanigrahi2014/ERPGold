package com.nexus.hm.application.support;
...
public class CurrentContext {
    @Value("${nexus.hm.default-tenant-id}") private UUID defaultTenantId;
    @Value("${nexus.hm.system-user-id}") private UUID systemUserId;
