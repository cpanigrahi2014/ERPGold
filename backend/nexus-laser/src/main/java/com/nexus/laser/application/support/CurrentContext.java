package com.nexus.laser.application.support;
...
public class CurrentContext {
    @Value("${nexus.laser.default-tenant-id}") private UUID defaultTenantId;
    @Value("${nexus.laser.system-user-id}") private UUID systemUserId;
