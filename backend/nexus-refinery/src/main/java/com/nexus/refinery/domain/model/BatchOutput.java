...
@Entity
@Table(name = "refinery_batch_outputs", indexes = {
    @Index(name = "ix_rbo_batch", columnList = "batch_id")
})
@Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
public class BatchOutput extends BaseEntity {
    @Column(name = "batch_id", nullable = false) private UUID batchId;
    @Column(name = "bar_no", length = 40) private String barNo;          // e.g. RB-001
    @Column(name = "form", length = 30) private String form;             // BAR, GRAIN, SPONGE
    ...
    @Column(name = "to_lot_id") private UUID toLotId;                    // optional inventory lot ref
