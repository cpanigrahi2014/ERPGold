package com.nexus.records.application.support;
...
public class CurrentContext {
    @Value("${nexus.records.default-tenant-id}") private UUID defaultTenantId;
    @Value("${nexus.records.system-user-id}") private UUID systemUserId;
